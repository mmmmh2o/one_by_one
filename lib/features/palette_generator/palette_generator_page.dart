...
class _PaletteGeneratorPageState
  ...
  void initState() {
    super.initState();
    _seedController = TextEditingController(text: 'toolbox');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('配色方案生成')),
      body: Padding(
              ...
              child: Column(
                children: [
                  AppInput(
                    ...
                    hint: '例如 brand / spring / sunset',
                    onChanged: notifier.setSeed,
                  ),
                  ...
                  Slider(
                    ...
                    onChanged: (v) => notifier.setCount(v.round()),
                  ),
                ],
              ),
            ),
