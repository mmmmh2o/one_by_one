...
class _UnicodeCodecPageState extends ConsumerState<UnicodeCodecPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ToolScaffold(
      toolId: 'unicode_codec',
      children: [
        AppCard(child: TextField(controller: _controller, minLines: 5, maxLines: 8, decoration: const InputDecoration(hintText: '输入普通文本或 \\u4F60\\u597D / \\u{1F44D}', border: InputBorder.none), onChanged: notifier.setInput)),
        ...
        Text('支持 \\uXXXX 与 \\u{1F44D} 两种格式', style: scaledTextStyle(Theme.of(context).textTheme.bodySmall, ui.textScaleFactor)),
      ],
    );
  }
}
