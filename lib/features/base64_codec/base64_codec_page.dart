...
class _Base64CodecPageState extends ConsumerState<Base64CodecPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ToolScaffold(
      toolId: 'base64_codec',
      children: [
        AppCard(child: TextField(controller: _controller, minLines: 5, maxLines: 8, decoration: const InputDecoration(hintText: '输入需要编码/解码的文本', border: InputBorder.none), onChanged: notifier.setInput)),
        ...
        Wrap(spacing: AppSpacing.sm, children: [
          ActionChip(label: const Text('示例'), onPressed: () { const s = 'hello toolbox'; _controller.text = s; notifier.setInput(s); }),
