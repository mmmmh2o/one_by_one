...
class _BaseConverterPageState extends ConsumerState<BaseConverterPage> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<int>(
                    ...
                    items: _baseItems,
                    onChanged: (value) {
                      if (value != null) notifier.setFromBase(value);
                    },
                  ),
                  const SizedBox(height: AppSpacing.md),
                  DropdownButtonFormField<int>(
                    ...
                    items: _baseItems,
                    onChanged: (value) {
                      if (value != null) notifier.setToBase(value);
                    },
                  ),
                ],
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (state.error != null)
                    ...
                    SelectableText(
                      state.output.isEmpty ? '等待输入并转换' : state.output,
  ...
  List<DropdownMenuItem<int>> get _baseItems => const [
