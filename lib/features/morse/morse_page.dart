...
class _MorsePageState extends ConsumerState<MorsePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('摩尔斯电码')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: AppButton(label: '编码', onPressed: notifier.encode),
                ),
                const SizedBox(width: AppSpacing.sm),
                Expanded(
                  child: AppButton(label: '解码', onPressed: notifier.decode, isPrimary: false),
                ),
              ],
            ),
