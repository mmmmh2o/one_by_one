...
class _RegexTesterPageState extends ConsumerState<RegexTesterPage> {
  ...
  void initState() {
    super.initState();
    _patternController = TextEditingController(text: r'\b\w+@\w+\.\w+\b');
    _inputController = TextEditingController(text: 'mail: demo@example.com');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('正则测试器')),
      body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  TextField(
                    ...
                    minLines: 4,
                    maxLines: 6,
                    decoration: const InputDecoration(labelText: '测试文本'),
                  ...
                  Wrap(
                    ...
                    children: [
                      FilterChip(
                        ...
                        onSelected: notifier.setCaseSensitive,
                      ),
                      FilterChip(
                        label: const Text('多行模式'),
                        selected: state.multiLine,
                        onSelected: notifier.setMultiLine,
                      ),
                      FilterChip(
                        label: const Text('dotAll'),
                        selected: state.dotAll,
                        onSelected: notifier.setDotAll,
                      ),
                    ],
                  ),
                ],
